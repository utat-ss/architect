...
logging.config.fileConfig(fname="log.conf", defaults={"path": log_path}, disable_existing_loggers=False)
...
a_in = np.linspace(start=0, stop=20, num=1)
d = np.linspace(start=0.5, end=4, num=0.5)
n_g = 0.1
n_3 = 1.3
n_2 = 1.52
n_1 = 1.0 
...
if __name__ == "__main__":
    ...
    diffractor = diffractors.VPHGrism(m=1, l=lmbda, v=v, a_in=a_in,eff_mat=eff_mat)
    # endregion
